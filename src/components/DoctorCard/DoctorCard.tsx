    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 focus-within:ring-2 focus-within:ring-blue-500">
      ...
      <div className="p-4">
        ...
        {doctor.isFullyBooked ? (
          <div className="mt-4 flex items-center justify-center p-2 bg-gray-100 rounded-md">
            <Calendar className="text-gray-500 mr-2" size={18} />
            <span className="text-gray-600 font-medium">Fully Booked</span>
          </div>
        ) : (
          <button
            onClick={() => setSelectedDoctor(doctor)}
            className="mt-4 w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
